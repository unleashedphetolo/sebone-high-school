    ...
    <section className="container" style={{ paddingTop: 28, paddingBottom: 40 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
        <Card>
          ...
          <Button to="/activities/academics" variant="outline">Explore</Button>
        </Card>
        ...
        <Card>
          ...
          <Button to="/activities/sports" variant="outline">Explore</Button>
        </Card>
        ...
        <Card>
          ...
          <Button to="/activities/culture" variant="outline">Explore</Button>
        </Card>
        ...
        <Card>
          ...
          <Button to="/activities/facilities" variant="outline">Explore</Button>
        </Card>
      </div>
    </section>
  );
