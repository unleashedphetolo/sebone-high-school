    ...
    <main className="wwa container">
      ...
      <header className="wwa-hero">
        <div className="wwa-hero-left">
          ...
          <p className="wwa-subtitle">
            M.O.M Sebone Secondary School is a learner-centred institution committed to
            academic excellence, discipline, and holistic development—supported by educators,
      ...
      <section className="wwa-grid">
        ...
        <Card>
          ...
          <p className="wwa-text">
            Our leadership promotes quality teaching, structured learner support, and
      ...
      <section className="wwa-footer">
        <div className="wwa-callout">
          ...
          <p className="wwa-callout-text">
            We are committed to developing responsible, confident learners who are prepared
            for further education, training, and active citizenship.
          </p>
        </div>
      </section>
    </main>
